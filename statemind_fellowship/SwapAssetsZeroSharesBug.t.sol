...
contract SwapAssetsZeroSharesBugTest is MetaVaultTestHelpers {
    ...
    function test_swap1Wei_absorbsEthReturnsZeroShares() public {
        // The first mint is 1:1, so the exchange totalAssets/totalShares == 1.
        ...
        // which is produced by real controller math, not by a mocked return value.
        vm.prank(keeper);
